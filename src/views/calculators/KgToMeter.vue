<template>
  <div>
    <div class="mb-5">
      <h1 class="page-title">⚖️ Knits: Kg → Meter Conversion</h1>
      <p class="page-subtitle">Convert knitted fabric weight (kg) to length (meters).</p>
    </div>
    ...
    <div class="section-card mb-4">
      <div class="space-y-4">
        ...
        <div>
          ...
          <p class="text-xs text-gray-400 mt-1">Knit fabric width in centimeters (e.g., 160 cm = 63")</p>
        </div>
      </div>
    ...
    <div v-if="result !== null" class="section-card">
      ...
      <div class="result-box text-center mb-3">
        ...
        <div class="result-label">Fabric Length in Meters</div>
      </div>
      <div class="grid grid-cols-2 gap-3">
        <div class="bg-gray-50 border border-gray-200 rounded-xl p-3 text-center">
          <div class="text-xl font-bold text-gray-700">{{ result.yards }}</div>
          <div class="text-xs text-gray-500 mt-0.5">Yards</div>
        </div>
        <div class="bg-gray-50 border border-gray-200 rounded-xl p-3 text-center">
